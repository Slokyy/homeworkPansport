...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12 text-white">
            <h2 class="super">KONTAKT<span class="supericonf">///</span></h2></h2>
            <div class="row" style="background: radial-gradient(ellipse farthest-corner at 50% 50%,#f4f5f5 0%,#24e1ff 100%); color:#00f; width:102%;">



                <div class="col-lg-6">
                    <h4 class="kontakt">GENERALNI PODACI PREDUZECA</h4>
                    <h4 class="kontakt1">Pansport d.o.o.</h4>
                ...
                <div class="col-lg-6">
                    <h4 class="kontakt1">KONTAKT FORMA</h4><br>
                    <form action="#" method="post">
                    <div class="row">
                        <div class="col-lg-6 text-black">
                                <div class="form-group">
                                    <label for="ime">Ime i prezime</label>
                                    <input type="text" class="form-control" id="ime" placeholder="Ime i Prezime">
                        ...
                        <div class="col-lg-6 text-black">
                            ...
                            <div class="form-group">
                                <label for="preduzece">Naziv preduzeća</label>
                                <input type="text" class="form-control" id="preduzece" placeholder="Naziv preduzeća">

                            </div>
                            <div class="form-group">
                                <label for="telefon">Telefon</label>
                                <input type="text" class="form-control" id="telefon" placeholder="Broj telefona">
                            </div>
                        </div>

                        <div class="col-lg-12 text-black">
                            <!--<p>Poruka <span style="color:#f00;">*</span></p>
                            <textarea rows="6" style="width:91.5%;"></textarea>-->
                            <div class="form-group">
                                <label for="poruka">Poruka:</label>
                                <textarea class="form-control" rows="5" id="poruka"></textarea><br><br>
                            ...
                            <br>
                            <button type="submit" class="btn btn-blue-o ">Pošaljite poruku</button>
