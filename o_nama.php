...
<div class="container">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="o_nama.php">O NAMA <span class="sr-only">(current)</span></a></li>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12 text-white">
            <h2 class="super">O NAMA <span class="supericonf">///</span></h2></h2>
            <div class="row" style="background: radial-gradient(ellipse farthest-corner at 50% 50%,#f4f5f5 0%,#24e1ff 100%); color:#00f; width:102%;">
                <div class="col-lg-12">
                    <img src="images/pansport-sivi-logo.png" class="img-responsive" alt="logo"><br>
                    <p class="text-black">U moderno vreme neuravnotežene ishrane i smanjene fizičke aktivnosti, suplementi predstavljaju neizostavni deo Vašeg života, ukoliko brinete o svom zdravlju. Briga o porodici i bližnjima je jedna od najlepših ljudskih osobina, a njena najvažnija odlika je briga o zdravlju.</p>
                    <br>
                    <p class="text-black">Uz veliki entuzijazam, posvećenost i ljubav prema zdravom životu, sportu i pravilnoj ishrani, sredinom 2001. godine otvorena je prva Pansport prodavnica u Novom Sadu. U toku 15 godina poslovanja koje su usledile, Pansport postaje jedan od vodećih ovlašćenih uvoznika i distributera prirodnih dodataka ishrani za sportiste i rekreativce na ovdašnjem tržištu. Širimo mrežu svojih maloprodajnih objekata, i sada ih je 24 u Srbiji (u Beogradu 6, u Novom Sadu 3, u Nišu 2, a u ostalim gradovima gde smo prisutni po jedna) i 3 u Bosni i Hercegovini (u Banja Luci, Bijeljini i Tuzli).</p>
                    <br>
                    <p class="text-black">U manjiim gradovima i selima širom Srbije, Pansport snabdeva potrošače preko mreža apoteka, teretana, fitnes centara i direktnih distributera, kojih ima preko dvesto, što potrošačima sa ovih prostora omogućava da dođu do neophodnih dodataka ishrani. Pre svega tu mislimo na vitamine, minerale, biljne ekstrakte, proteine, kreatin, NO reaktore, amino kiseline, zatim, preparate koji se koriste za lakše i brže dobijanje telesne i mišićne mase, suplemente za poboljšanja opšteg zdravlja, sagorevače masti, preparate za oporavak, sportsku opremu i još mnogo toga. Kvalitet i zdravstvenu ispravnost proizvoda iz Pansportovog asortimana svojim sertifikatima potvrđuju renomirani proizvođači, ali i srpske nadležne institucije (Ministarstvo zdravlja i Farmaceutski faktltet Beograd), što pozitivno govori o Pansportovoj brizi o zdravlju potrošača suplemenata.</p>
                    <br>
                    <p class="text-black">Pansport kompaniju čini mlad i ambiciozan tim stručnih ljudi iz oblasti fitnesa, nutricionizma, medicine, kao i sporta i suplementacije.</p>
                    <br>
                    <p class="text-black">Kako bi održali korak s trendovima, pored sajta <a href="#">www.pansport.eu</a> stručni saradnici daju sve potrebne informacije na Pansport-ovom forumu, kao i na fan stranici društvene mreže Facebook u okviru koje možete aktivno učestvovati u diskusijama, dobiti odgovore na sva pitanja i informisati se o akcijama i super ponudama.</p>
                    <br>
                    <p class="text-black">U skladu sa trendovima, Pansport ima i svoj YouTube kanal, na kojem možete pogledati sve video-izveštaje Pansporta, sa takmičenja koje organizujemo i manifestacija na kojima učestvujemo, i Instagram profil na kojem možete pratiti i zanimljivosti koje se svakodnevno dešavaju unutar kompanije i osetiti da ste deo velike Pansport porodice.</p>
                    <br>
                    <h4 class="text-black">Kontakt</h4>
                    <p class="text-black"><b>Tel:</b> 021/820-245</p>
                    <p class="text-black"><b>Fax:</b> 021/820-555</p>
                    <p class="text-black"><b>Mob:</b> 062/111-0-999</p>
                    <br>
                    <p class="text-black"><b>E-mail:</b> <a href="mailto:info@pansport.eu">info@pansport.eu</a></p>
                    <br>
                    <p class="text-black"><b>Adresa:</b> Stevana Peci Popovića 21, Veternik</p>
                    <br>
                    <p class="text-black">Podatke za identifikaciju možete preuzeti sa <a href="#">kontakt stranice</a>.</p>
                    <br>
                </div>
            </div>
            <!-- /.row -->
